    ...
    <form id="form1" runat="server">
        ...
        <div id="panel-container" class="panel-container">
            <div class="left-panel">
                ...
                <div class="buttons-panel" style="background-color:none;">
                    ...
                    <button id="add-button" class="panel-button" onclick="window.location.href = 'createScreen.aspx';">Add a new Machine</button>
                    <button id="chart-button" class="panel-button" type="button" >Show as Pi Chart</button>
            ...
            function updatePagination() {
                ...
                if (Math.ceil(tableRows.length / rowsPerPage) > maxPage) {
                    if (currentPage > (maxPage / 2)) {
                        ...
                        setupPagination(1, Math.ceil(filtredRows.length / rowsPerPage));
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                function editRow(rowName) {
                    window.location.href = "editScreen.aspx?name=" + rowName;
        ...
        <script>
            function showCharts() {
                ...
                localStorage.setItem('dizi', JSON.stringify(uniqueValues));
                window.location.href = "pichart.aspx";
            }
